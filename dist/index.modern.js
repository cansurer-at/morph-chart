...
import { line as line$1, curveCatmullRom } from 'd3-shape';
...
var ChartModel = function ChartModel(_data, _width, _height, _state) {
  ...
  this.calcPath = function () {
    ...
    var scaleX = scaleLinear().domain([Math.min.apply(Math, indices), Math.max.apply(Math, indices)]).range([0, _this.width * relDataPoints]);
    var minPrice = Math.min.apply(Math, prices);
    var maxPrice = Math.max.apply(Math, prices);
    var scaleY = scaleLinear().domain([minPrice, maxPrice]).range([_this.height - 10, 10]);
    return {
      minPrice: minPrice,
      maxPrice: maxPrice,
      datapoints: datapoints,
      path: line$1().x(function (_ref) {
        var x = _ref[1];
        return scaleX(x);
      }).y(function (_ref2) {
        var y = _ref2[0];
        return scaleY(y);
      }).curve(curveCatmullRom.alpha(0.2))(formattedValues)
    };
  };
  ...
  this.getInterpolatedPath = function () {
    ...
    return interpolatePath(_this.pathData.path, current.path);
  };
...
var Header = function Header(_ref) {
  ...
  }, headerData.title), !headerConfig.currentValue.display ? null : React.createElement("h1", {
    className: styles.dpValue
  }, headerData.dataPointValue), !headerConfig.percentageChange.display && !headerConfig.labels.display ? null : React.createElement("div", null, React.createElement("p", {
    className: styles.percentChange
  }, headerConfig.percentageChange.display ? headerData.percentChange + "%" : null), React.createElement("p", {
...
var LabelButtons = function LabelButtons(_ref) {
  ...
  return React.createElement("div", null, chartLabels === null ? null : React.createElement("div", {
...
var Graph = function Graph(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: "header"
  }, children === undefined ? React.createElement(Header, {
    headerData: headerData,
    headerConfig: headerConfig
  }) : children(headerData)), React.createElement("svg", {
    width: chartModel.width,
    ...
    opacity: 0.7
  })), React.createElement(LabelButtons, {
    chartLabels: chartLabels,
